...
fName = [
    ...
    0x69, 0x6D, 0x61, 0x6C, 0x2E, 0x72, 0x6F, 0x6F, 0x74, 0x00, 0x18, 0x74, 0x65, 0x73, 0x74, 0x5F, 
    0x6E, 0x74, 0x75, 0x70, 0x6C, 0x65, 0x5F, 0x6D, 0x69, 0x6E, 0x69, 0x6D, 0x61, 0x6C, 0x2E, 0x72, 
    0x6F, 0x6F, 0x74, 0x00, 
]
...
@show length(REFERENCE_BYTES) 
MINE = [file_preamble; dummy_FileHeader; dummy_padding1; fName; dummy_DirectoryHeader32; dummy_padding2;
RBlob1; rnt_header; RBlob2; page1; RBlob3; linkedlist_envelope; RBlob4; rnt_footer;
tkey32_anchor; magic_6bytes; rnt_anchor; tkey32_TDirectory; n_keys; tkey32_anchor;
tkey32_TStreamerInfo; tsreamerinfo_compressed; tfile_end]
