...
Base.precompile(Tuple{typeof(interp_jaggT),TBranch_13,TLeafI})
...
Base.precompile(Tuple{typeof(Table),ROOTFile,String,Vector{String}})
Base.precompile(Tuple{typeof(interped_data),Vector{UInt8},Vector{Int32},TBranch_13,Type{Nojagg},Type{Int32}})
Base.precompile(Tuple{typeof(interped_data),Vector{UInt8},Vector{Int32},TBranch_13,Type{Nojagg},Type{UInt32}})
Base.precompile(Tuple{typeof(show),IOContext{IOBuffer},LazyBranch{Vector{Float32}, Nooffsetjagg}})
Base.precompile(Tuple{typeof(interped_data),Vector{UInt8},Vector{Int32},TBranch_13,Type{Nojagg},Type{Bool}})
Base.precompile(Tuple{typeof(unpack),IOBuffer,TKey32,Dict{Int32, Any},Type{TStreamerObject}})
Base.precompile(Tuple{typeof(interp_jaggT),TBranch_13,TLeafB})
...
Base.precompile(Tuple{typeof(interp_jaggT),TBranch_13,TLeafO})
...
Base.precompile(Tuple{typeof(interped_data),Vector{UInt8},Vector{Int32},TBranch_13,Type{Nojagg},Type{Float32}})
Base.precompile(Tuple{typeof(keys),TTree})
Base.precompile(Tuple{typeof(decompress_datastreambytes),Vector{UInt8},TBasketKey})
Base.precompile(Tuple{typeof(getindex),LazyBranch{Vector{Float32}, Nooffsetjagg},Int64})
Base.precompile(Tuple{typeof(Table),ROOTFile,String})
...
Base.precompile(Tuple{typeof(interped_data),Vector{UInt8},Vector{Int32},TBranch_13,Type{Nojagg},Type{UInt64}})
...
Base.precompile(Tuple{typeof(interped_data),Vector{UInt8},Vector{Int32},TBranch_13,Type{Nojagg},Type{UInt8}})
