...
Base.show(io::IO, v::LazyTreeView; kwargs...) = _show(io, v; kwargs...)
Base.show(io::IO, ::MIME"text/plain", v::LazyTreeView) = _show(io, v)
function _show(io::IO, tree::Union{LazyTree, LazyTreeView}; kwargs...)
