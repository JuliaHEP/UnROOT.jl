...
dummy_FileHeader = [
    ...
    0x65, 0x00, 0x00, 0x01, 0x8d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
dummy_tdirectory32 = [
    0x00, 0x05, WRITE_TIME_ary..., WRITE_TIME_ary...,0x00, 0x00, 0x00, 0x6b, 0x00, 0x00,
...
field_record = UnROOT.FieldRecord(zero(UInt32), zero(UInt32), zero(UInt32), zero(UInt16), zero(UInt16), "one_uint", "std::uint32_t", "", "", 0, -1, -1)
dummy_field_record = [
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x6F, 0x6E, 0x65, 0x5F, 0x75, 0x69, 0x6E, 0x74, 0x0D,
    0x00, 0x00, 0x00, 0x73, 0x74, 0x64, 0x3A, 0x3A, 0x75, 0x69, 0x6E, 0x74, 0x33, 0x32, 0x5F, 0x74,
...
dummy_rnt_header_payload = [
    ...
    , 
...
dummy_rnt_header = [0x01, 0x00, 0xBB, 0x00, 0x00, 0x00, 0x00, 0x00, dummy_rnt_header_payload...,
    0x45, 0x83, 0x5E, 0xDC, 0x32, 0x3B, 0x63, 0xF6]
...
dummy_RBlob2 = [
    ...
    0x00, 0x01, 0x00, 0x00, 0x01, 0xD1, 0x00, 0x00, 0x00, 0x64, 0x05, 0x52, 0x42, 0x6C, 0x6F, 0x62,
    0x00, 0x00,
]
...
dummy_RBlob3 = [
    ...
    0x00, 0x01, 0x00, 0x00, 0x01, 0xFF, 0x00, 0x00, 0x00, 0x64, 0x05, 0x52, 0x42, 0x6C, 0x6F, 0x62,
    0x00, 0x00,
]
...
dummy_RBlob4 = [
    0x00, 0x00, 0x00, 0xB6, 0x00, 0x04, 0x00, 0x00, 0x00, 0x94, WRITE_TIME_ary...,         0x00, 0x22,
    0x00, 0x01, 0x00, 0x00, 0x02, 0x9D, 0x00, 0x00, 0x00, 0x64, 0x05, 0x52, 0x42, 0x6C, 0x6F, 0x62,
    0x00, 0x00,
]
test_io(UnROOT.Stubs.RBlob4, dummy_RBlob4)

dummy_rnt_footer = [
    0x02, 0x00, 0x94, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x45, 0x83, 0x5E, 0xDC, 0x32, 0x3B, 0x63, 0xF6, 0x38, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    ...
    0xC4, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x01, 0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 
    0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x7C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0x7C, 0x00, 0x00, 0x00, 0x21, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x28, 0x5C, 0x57, 0xA4, 
    0x30, 0x96, 0x5B, 0xC8, 
]
...
dummy_rnt_anchor = [
    0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x16, 
    ...
    0xc5, 0xe5, 0xfd, 0xe2, 0xa7, 0xda, 0xcc, 0xc3
]
test_io(UnROOT.Stubs.rnt_anchor, dummy_rnt_anchor)

dummy_tkey32_TDirectory = [
    0x00, 0x00, 0x00, 0x6B, 0x00, 0x04, 0x00, 0x00, 0x00, 0x36, 0x76, 0xDB, 0x50, 0x93, 0x00, 0x35, 
    0x00, 0x01, 0x00, 0x00, 0x03, 0xD3, 0x00, 0x00, 0x00, 0x64, 0x00, 0x18, 0x74, 0x65, 0x73, 0x74, 
...
dummy_tkey32_TStreamerInfo = [
    0x00, 0x00, 0x01, 0x8D, 0x00, 0x04, 0x00, 0x00, 0x04, 0xE6, WRITE_TIME_ary...,         0x00, 0x40,
    0x00, 0x01, 0x00, 0x00, 0x04, 0x3e, 0x00, 0x00, 0x00, 0x64, 0x05, 0x54, 0x4C, 0x69, 0x73, 0x74,
