...
telescope [@Adri_n_Mart_nez_2016]. And just like `RDataFrame`,
it can be directly used on "NTuple" `TTree` such as the 
NANOAOD format used by the CMS collaboration [@Ehataht:2020ebp].
